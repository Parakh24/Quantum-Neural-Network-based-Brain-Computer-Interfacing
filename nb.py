...
# ---------------------- Model Pipeline ----------------------
def process_naive_bayes(df, title):
...
metrics_40x = process_naive_bayes(df_40x, "Histopathological_40x")
metrics_100x = process_naive_bayes(df_100x, "Histopathological_100x")
metrics_200x = process_naive_bayes(df_200x, "Histopathological_200x")
metrics_400x = process_naive_bayes(df_400x, "Histopathological_400x")
...
plt.title("Naive Bayes Evaluation Metrics: 40x vs 100x vs 200x vs 400x Histopathological Datasets")
