...
# ---------------------- Model Evaluation ----------------------
print("Accuracy Score for Histopathological_40x (RF):", accuracy_score(y_test, y_pred_2)*100)
print("Precision Score for Histopathological_40x (RF):", precision_score(y_test, y_pred_2)*100)
print("Recall Score for Histopathological_40x (RF):", recall_score(y_test, y_pred_2)*100)
print("F1 Score for Histopathological_40x (RF):", f1_score(y_test, y_pred_2)*100)
